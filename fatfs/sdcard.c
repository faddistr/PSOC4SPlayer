...
#define CONCAT(name, function)                      name##function
    ...
    #define mmSPI_SpiFullRXSize                         CONCATENATE(SPI_NAME, _SPI_RX_BUFFER_SIZE)
#endif    
...
static void rcvr_mmc(BYTE *buff, UINT bc)
{
    ...
    do
    {
        ...
        while (!mmSPI_SpiUartGetRxBufferSize()) {};
